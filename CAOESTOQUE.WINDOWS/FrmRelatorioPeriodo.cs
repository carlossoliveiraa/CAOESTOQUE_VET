    ...
    public partial class FrmRelatorioPeriodo : Form
    {
        ...
        private void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            if (DateTime.TryParse(datein, out dateinn) && DateTime.TryParse(dateend, out dateendd))
            {
                ...
                var list = new RelatorioPeriodoMetodos().ListarporPeriodo(datein, dateend);
                ...
                lblTotalProdutosVendidos.Text = totalItens.ToString();
                lblTotalVendas.Text = totalPedido.ToString();
            }
        }
